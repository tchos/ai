 ...
 */
final class Version20200330133803 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE invalidite (id INT AUTO_INCREMENT NOT NULL, agent_saisie_id INT DEFAULT NULL, matricul_inv VARCHAR(7) NOT NULL, nom_agent_invalide VARCHAR(255) NOT NULL, sexe VARCHAR(255) DEFAULT NULL, date_nais DATE DEFAULT NULL, num_acte_inval VARCHAR(255) DEFAULT NULL, type_acte_inv VARCHAR(255) DEFAULT NULL, date_signature_inv DATE DEFAULT NULL, noms_inv_acte VARCHAR(255) DEFAULT NULL, date_invalidite DATE DEFAULT NULL, cc_inv INT DEFAULT NULL, cc INT DEFAULT NULL, resultat INT DEFAULT NULL, precontentieux INT DEFAULT NULL, a_affect INT DEFAULT NULL, date_saisie DATETIME DEFAULT NULL, why_is_not_authentik LONGTEXT DEFAULT NULL, is_authentik TINYINT(1) DEFAULT NULL, INDEX IDX_73FAA17F5670B5A9 (agent_saisie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE equipe (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, responsable VARCHAR(255) NOT NULL, mission VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reversion (id INT AUTO_INCREMENT NOT NULL, agent_saisie_id INT DEFAULT NULL, matricul VARCHAR(7) NOT NULL, noms_ayant_droit VARCHAR(255) NOT NULL, sexe VARCHAR(255) DEFAULT NULL, date_nais DATE DEFAULT NULL, qualite_ayant_droit VARCHAR(255) DEFAULT NULL, date_nais_der_orph DATE DEFAULT NULL, ccay INT NOT NULL, cc INT DEFAULT NULL, date_affectat DATE DEFAULT NULL, noms_auteur VARCHAR(255) DEFAULT NULL, matricule_auteur VARCHAR(7) DEFAULT NULL, ministere VARCHAR(255) DEFAULT NULL, date_deces DATE DEFAULT NULL, noms_ad_acte VARCHAR(255) DEFAULT NULL, num_acte_revers VARCHAR(255) DEFAULT NULL, type_acte VARCHAR(255) DEFAULT NULL, date_signature_rev DATE DEFAULT NULL, conforme_y_n TINYINT(1) DEFAULT NULL, date_saisie DATETIME DEFAULT NULL, resultat INT DEFAULT NULL, precontentieux INT DEFAULT NULL, a_affect INT DEFAULT NULL, why_is_not_authentik LONGTEXT DEFAULT NULL, INDEX IDX_82275D9F5670B5A9 (agent_saisie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
