...
/**
 * @ORM\Entity(repositoryClass="App\Repository\RegulReversionRepository")
 */
class RegulReversion
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="regulReversions")
     */
    private $agentSaisie;
